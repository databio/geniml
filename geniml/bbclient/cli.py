...
def download_and_process_bed_region(args):
    ...
    bed_regions = bed_processor.download_and_process_bed_region_data(args.input_identifier, args.chr, args.start, args.end)
    print(bed_regions)
...
def build_subparser(parser):
    ...
    parser_region.add_argument('--cache-folder', default='bed_cache', help='Cache folder path (default: bed_cache)')
    ...
    parser_local.add_argument('--cache-folder', default='bed_cache', help='Cache folder path (default: bed_cache)')
