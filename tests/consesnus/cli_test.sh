...
gitk universe cc --coverage-folder tests/consesnus/coverage/  \
                       --output-file tests/consesnus/results/universe/cc_universe.bed

gitk universe ccf --coverage-folder tests/consesnus/coverage/  \
                       --output-file tests/consesnus/results/universe/ccf_universe.bed

gitk universe ml --model-file tests/consesnus/results/lh_model.tar \
                          --output-file tests/consesnus/results/universe/ml_universe.bed\
                          --coverage-folder tests/consesnus/coverage/

# make HMM universe
gitk universe hmm --output-file tests/consesnus/results/universe/hmm_universe.bed --coverage-folder tests/consesnus/coverage/


# assessment
 gitk assess --raw-data-folder tests/consesnus/raw/\
