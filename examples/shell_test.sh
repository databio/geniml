...
bedshift --bedfile $(dirname "$0")/test.bed --droprate 0.1 --addrate 0.2 --addfile $(dirname "$0")/test.bed --shiftrate 0.3 --shiftmean 0.0  --shiftstdev 150.0  --cutrate 0.1  --mergerate 0.2  --outputfile $(dirname "$0")/sh_output2.bed
